...
$(document).ready(function(){
...
</script><div class="content"><div class="cLineB"><h4 class="left">自定义回复信息</h4><div class="clr"></div></div><div class="cLine"><div class="pageNavigator left"><a href='<?php echo U("Text/add");?>' title='新增文本自定义回复' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/text.png" class="vm" />新增文本自定义回复</a>　
  <a href='<?php echo U("Img/add");?>' title='新增图文自定义回复' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/pic.png" class="vm" />新增图文自定义回复</a>　
            ...
            </div><div class="clr"></div></div><div class="msgWrap"><TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%"><THEAD><TR><TH class="answer">标题</TH><TH class="keywords">关键词</TH><TH  class="category" >分类</TH><TH class="time">浏览次数</TH><TH class="time">时间</TH><TH class="edit norightborder">操作</TH></TR></THEAD><TBODY><TR></TR><?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><div class="answer_text"><img src="<?php echo RES;?>/images/pic.png" class="vm" title="图文自定义内容"><?php echo ($vo["title"]); ?></div></td><td><?php echo ($vo["keyword"]); ?></td><td><?php echo ($vo["classname"]); ?></td><td><?php echo ($vo["click"]); ?></td><td><?php echo date('Y-m-d',$vo['uptatetime']); ?></td><td class="norightborder"><!--a target="ddd" href="<?php echo U('Wap/Index/content',array('token'=>$_SESSION['token'],'id'=>$vo['id']));?>">查看</a--><a href="<?php echo U('Img/edit',array('id'=>$vo['id']));?>" title="编辑图文自定义回复">编辑</a><a href="<?php echo U('Img/del',array('id'=>$vo['id']));?>">删除</a></td></tr><?php endforeach; endif; else: echo "" ;endif; ?></TBODY></TABLE><script>   function checkvotethis() {
...
alert('未选中任何文章或回复！')
   ...
   </script></div><div class="cLine"><div class="pageNavigator right"><div class="pages"><?php echo ($page); ?></div></div><div class="clr"></div></div></div><div class="clr"></div></div></div></div><script>function checkAll(form, name) {
