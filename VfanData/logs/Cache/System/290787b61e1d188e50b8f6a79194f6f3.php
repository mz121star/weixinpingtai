 ...
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo C('site_url');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://pigcms.cn</span>
    </tr>  
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="counts" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo base64_decode(C('counts'));?></textarea><span>&nbsp;&nbsp;例:51啦统计,cnzz统计</span>
    </tr>
	<tr> 
